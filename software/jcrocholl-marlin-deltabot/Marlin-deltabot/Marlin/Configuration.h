...
#define DELTA_DIAGONAL_ROD 302.116 //287.01 //285.185011419 // mm
...
#define DELTA_PRINTABLE_RADIUS 80.0 // ahould be around 100.0 without the effector fan
...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 0.0  //-1.0
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0.0  //21.0
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0.9  //-6.7
...
#define MANUAL_Z_HOME_POS 372.8 // 214  // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 130}
